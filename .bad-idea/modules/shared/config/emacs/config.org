...
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "mk5r"
    user-mail-address "github@kantzer.io")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/mk5r/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/mk5r/bin" "/profile/bin" "/Users/mk5r/.npm-packages/bin" "/Users/mk5r/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
