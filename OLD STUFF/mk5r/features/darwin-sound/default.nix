...
# Not needed anymore: superseded by SoundSource's settings > audio > super volume keys

# {
#   home.file."Library/Application Scripts/net.mousedown.EventScripts/switchAudioPlugIn.sh" = {
#     executable = true;
#     text = ''
#       #!/bin/bash
...
#     '';
#   };
#   home.file."Library/Application Scripts/net.mousedown.EventScripts/switchAudioPlugOut.sh" = {
#     executable = true;
#     text = ''
#       #!/bin/bash
